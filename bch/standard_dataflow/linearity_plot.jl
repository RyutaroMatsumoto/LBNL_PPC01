...
µ_fit = [asic.par.rpars.ecal[period, DataRun(run), channel].µ for run in runs]
pulser_fit = [asic.par.rpars.ecal[period, DataRun(run), channel].µ_pulser for run in runs]
